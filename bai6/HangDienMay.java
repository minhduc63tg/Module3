...
public class HangDienMay extends HangHoa {
    private static final int DEFAULT_THOI_GIAN_BAO_HANH = 1;
    private static final double DEFAULT_CONG_SUAT = 1.0;
    ...
    public HangDienMay() {
        super();
        this.thoiGianBaoHanh = DEFAULT_THOI_GIAN_BAO_HANH;
        this.congSuat = DEFAULT_CONG_SUAT;
    }
